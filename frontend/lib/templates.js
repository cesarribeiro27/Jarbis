...
export const TEMPLATES = [
...

  {
    ...
    blocks: [
      ...
      { id: bid(), type: 'bar',   title: 'Receita por Produto', dataset_id: null, label_col: null, value_col: null, agg: 'sum',   static_data: PRODUTOS,                             config: { format: 'currency' },                                         layout: { x: 0, y: 2, w: 6, h: 5 } },
      { id: bid(), type: 'line',  title: 'Tendência Mensal',    dataset_id: null, label_col: null, value_col: null, agg: 'sum',   static_data: MESES,                                config: { format: 'currency', color: '#10b981' },                        layout: { x: 6, y: 2, w: 6, h: 5 } },
      { id: bid(), type: 'pie',   title: 'Mix por Categoria',   dataset_id: null, label_col: null, value_col: null, agg: 'sum',   static_data: CATEGORIAS,                           config: {},                                                              layout: { x: 0, y: 7, w: 4, h: 5 } },
      { id: bid(), type: 'table', title: 'Detalhamento',        dataset_id: null, label_col: null, value_col: null, agg: 'sum',   static_data: PRODUTOS,                             config: {},                                                              layout: { x: 4, y: 7, w: 8, h: 5 } },
    ],
  },
...

  {
    ...
    blocks: [
      ...
      { id: bid(), type: 'bar',   title: 'Comparativo Regional', dataset_id: null, label_col: null, value_col: null, agg: 'sum',   static_data: REGIOES,                              config: {},                                                            layout: { x: 0, y: 9, w: 12, h: 5 } },
    ],
  },

  {
    ...
    blocks: [
      ...
      { id: bid(), type: 'bar',   title: 'Verba por Veículo',    dataset_id: null, label_col: null, value_col: null, agg: 'sum',   static_data: VEICULOS,                             config: { format: 'currency' },                                        layout: { x: 0, y: 4, w: 6, h: 5 } },
      { id: bid(), type: 'pie',   title: 'Mix de Canais',        dataset_id: null, label_col: null, value_col: null, agg: 'sum',   static_data: CANAIS,                               config: {},                                                            layout: { x: 6, y: 4, w: 6, h: 5 } },
      { id: bid(), type: 'table', title: 'Detalhamento por Praça',dataset_id: null, label_col: null, value_col: null, agg: 'sum',  static_data: REGIOES,                              config: { format: 'currency' },                                        layout: { x: 0, y: 9, w: 12, h: 5 } },
    ],
  },
]
